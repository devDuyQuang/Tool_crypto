...
export default function CryptoExchangeEditPage() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            setLoading(true);
            try {
                const data = await cryptoExchangesService.findOne(id);
                setName(data.name || "");
            } catch (e: any) {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await cryptoExchangesService.update(id, payload);
    ...
    return (
        <div className="max-w-xl space-y-4">
            <h1 className="text-xl font-semibold">Edit Crypto Exchange</h1>
